      ...
      <div class="section">
        ...
        <table class="data-grid">
          ...
          <tr>
            ...
            <td colspan="2">${reporte.empleado_asignado_nombre ? `<span class="lbl">Técnico Asignado</span><span class="val">${reporte.empleado_asignado_nombre}</span>` : ''}</td>
          </tr>` : `${reporte.empleado_asignado_nombre ? `
          <tr>
            <td colspan="4"><span class="lbl">Técnico Asignado</span><span class="val">${reporte.empleado_asignado_nombre}</span></td>
          </tr>` : ''}`}
        </table>
      </div>
