...
CREATE TABLE IF NOT EXISTS reportes (
  ...
  estado ENUM('pendiente', 'en_proceso', 'cotizado', 'aceptado_por_cliente', 'finalizado_por_tecnico', 'cerrado_por_cliente', 'listo_para_encuesta', 'encuesta_satisfaccion', 'terminado', 'finalizado', 'en_espera', 'asignado', 'en_cotizacion') DEFAULT 'pendiente',
