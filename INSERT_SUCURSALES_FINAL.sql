...
-- Solución para error #1062

-- PASO 1: Desactivar restricciones de clave foránea
SET FOREIGN_KEY_CHECKS = 0;

-- PASO 2: Eliminar todos los registros de la tabla
DELETE FROM sucursales WHERE 1=1;

-- PASO 3: Resetear el contador de auto_increment a 1
ALTER TABLE sucursales AUTO_INCREMENT = 1;

-- PASO 4: Reactivar restricciones de clave foránea
SET FOREIGN_KEY_CHECKS = 1;

-- PASO 5: Insertar todos los registros
...
SELECT 'Inserción completada exitosamente' as mensaje;
